import { MissPunchRequest, getMissPunchList } from '@/lib/missPunchList';
...
const MissPunchList = () => {
    ...
    const fetchRequests = async (isRefresh = false) => {
        try {
            ...
            console.log('📋 Fetching missed punch requests...');
            const response = await getMissPunchList();
    ...
    // Get status info based on ApprovalStatus
    ...
    const renderRequestCard = ({ item }: { item: MissPunchRequest }) => {
        const statusInfo = getStatusInfo(item.ApprovalStatus);
            ...
            <View style={styles.requestCard}>
                ...
                <View style={styles.cardHeader}>
                    <View style={styles.idBadge}>
                        <Text style={styles.idText}>#{item.TranID}</Text>
                    </View>
        ...
        <SafeAreaView style={styles.container}>
            ...
            {!isLoading && !error && requests.length > 0 && (
                <FlatList
                    ...
                    keyExtractor={(item) => item.TranID.toString()}
